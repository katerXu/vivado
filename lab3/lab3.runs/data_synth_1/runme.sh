...
HD_PWD='C:/Users/xujh2649/Desktop/workspace/vivado/lab3/lab3.runs/data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data.tcl
